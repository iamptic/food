...
def kb():
    return InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text='🛒 Витрина', web_app=WebAppInfo(url=WEBAPP_BUYER_URL)), InlineKeyboardButton(text='👨‍🍳 ЛК партнёра', web_app=WebAppInfo(url=WEBAPP_MERCHANT_URL))]])
